...
const Navbar = (props)=>{
    ...
    marginBottom: '10px'}}>About </p>
    </a>}
    {props.name !== ''? <Link to='/'> <div className="navbar-brand" style={{color: "#28a745"}}>Welcome {props.name}</div></Link> : null}
  ...
  <div className="collapse navbar-collapse" id="navbarNav">
    <ul className="navbar-nav ml-auto">
      <li className="nav-item active">
       <Link to ='/questionType'> <a className="nav-link" style={{color: "#28a745"}} >Home</a></Link>
      ...
      {props.admin === true? <li><Link to='/adminCreateQuestion'><a className="nav-link"style={{color: "#28a745"}} >Admin</a></Link> </li>: null}
